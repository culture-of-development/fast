...
{
    public class DecisionTreeNaiveTests : TestsBase
    {
        public DecisionTreeNaiveTests(ITestOutputHelper output) : base(output) { }

        [Fact]
        public void TestDecisionTreeNaiveCreate()
        {
            var dt = DecisionTreeNaive.Create(exampleDecisionTree);
        ...
        [Fact]
        public void TestDecisionTreeNaiveEvaluate()
        {
            var dt = DecisionTreeNaive.Create(exampleDecisionTree);
